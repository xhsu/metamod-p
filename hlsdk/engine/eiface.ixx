...
export using KeyValueData = KeyValueData_s;
...
export inline constexpr auto MAX_LEVEL_CONNECTIONS = 16;		// These are encoded in the lower 16bits of ENTITYTABLE->flags
...
export inline constexpr auto FENTTABLE_PLAYER = 0x80000000;
export inline constexpr auto FENTTABLE_REMOVED = 0x40000000;
export inline constexpr auto FENTTABLE_MOVEABLE = 0x20000000;
export inline constexpr auto FENTTABLE_GLOBAL = 0x10000000;


export struct saverestore_s
{
...
export using SAVERESTOREDATA = saverestore_s;
...
export using NEW_DLL_FUNCTIONS_FN = int (*)(NEW_DLL_FUNCTIONS *pFunctionTable, int *interfaceVersion);

export using APIFUNCTION = int (*)(DLL_FUNCTIONS *pFunctionTable, int interfaceVersion);
export using APIFUNCTION2 = int (*)(DLL_FUNCTIONS *pFunctionTable, int *interfaceVersion);
