export module engine_launcher_api;
...
export inline constexpr auto RENDERTYPE_UNDEFINED = 0;
export inline constexpr auto RENDERTYPE_SOFTWARE = 1;
export inline constexpr auto RENDERTYPE_HARDWARE = 2;

export inline constexpr auto ENGINE_LAUNCHER_API_VERSION = 1;

export struct engine_api_s
{
	int		version;
	int		rendertype;
	int		size;
...
export using engine_api_t = engine_api_s;
