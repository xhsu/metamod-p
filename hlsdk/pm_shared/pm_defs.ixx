...
export inline constexpr auto MAX_PHYSENTS = 600;		  // Must have room for all entities in the world.
export inline constexpr auto MAX_MOVEENTS = 64;
export inline constexpr auto MAX_CLIP_PLANES = 5;

export inline constexpr auto PM_NORMAL = 0x00000000;
export inline constexpr auto PM_STUDIO_IGNORE = 0x00000001;		// Skip studio models
export inline constexpr auto PM_STUDIO_BOX = 0x00000002;		// Use boxes for non-complex studio models (even in traceline)
export inline constexpr auto PM_GLASS_IGNORE = 0x00000004;		// Ignore entities with non-normal rendermode
export inline constexpr auto PM_WORLD_ONLY = 0x00000008;		// Only trace against the world
...
export using physent_t = physent_s;


export struct playermove_s
{
...
export using playermove_t = playermove_s;
