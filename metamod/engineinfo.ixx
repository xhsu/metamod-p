...
export inline constexpr bool c_DefaultReturnOnInvalidState = true;

export inline constexpr int c_EngineInfo__typeLen = 10;


export class EngineInfo : public class_metamod_new
{
private:
	// data :
