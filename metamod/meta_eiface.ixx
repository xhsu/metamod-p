...
export inline constexpr int c_NumDummies = 5;
export using pdummyfunc = void (*)(void);
...
export struct meta_new_dll_functions_t : public NEW_DLL_FUNCTIONS
{
...
private:
	...
	static inline int sm_version = 0;
...
export struct meta_enginefuncs_t : public enginefuncs_t {
	// data :
...
//
export struct HL_enginefuncs_t : public meta_enginefuncs_t {
